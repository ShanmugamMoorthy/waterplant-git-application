...
@RestController
@EnableWebMvc
@RequestMapping(InquiryConstants.BASE_INQUIRY_URL)
public class WaterPlantInquiryMgmtController {

	@Autowired
	WaterPlantInquiryMgmtService inquryService;

	@RequestMapping(method = RequestMethod.GET, value = InquiryConstants.URL_USERS)
	...
	@RequestMapping(method = RequestMethod.GET, value = InquiryConstants.URL_USER_BY_ID)
